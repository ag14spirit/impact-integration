    ...
    return {
        ...
        link: function ($scope, $element, $attrs) {
            ...
            $scope.isDisabled = function (date) {
                ...
                if($scope.noInterviewsOnDay[prettyDate]) { return true; }
